...
switch(cenario){
       case 1: bits = LoadDIBitmap("textura1.bmp", &info);
               break;
       case 2: bits = LoadDIBitmap("textura2.bmp", &info);
               break;
       case 3: bits = LoadDIBitmap("textura3.bmp", &info);
               break;
       case 4: bits = LoadDIBitmap("textura4.bmp", &info);
               break;
       case 5: bits = LoadDIBitmap("textura5.bmp", &info);
               break;
       case 6: bits = LoadDIBitmap("textura6.bmp", &info);
               break;
       default: bits = LoadDIBitmap("textura1.bmp", &info);
                break;
       }
...
if (zDisco < -23.5){
           ...
           if ((xDisco > -7) && (xDisco < 7)) // Gol do Computador
                ...
                Janela3 = glutCreateSubWindow(Janela1,511,0,512,30);   //placar
...
int main(void)
{
    ...
    printf("Digite o numero do campo em que deseja jogar:\n");
    printf("1. Quadra de hoquei\n");
    printf("2. Tigre\n");
    printf("3. Cara feia\n");
    printf("4. Akuma\n");
    printf("5. Homem-Aranha\n");
    printf("6. Diablo\n");
    cin >> cenario;
	...
	Janela1 = glutCreateWindow("Air Hockey");
	init();
	...
	Janela2 = glutCreateSubWindow(Janela1,511,30,512,369);   //visão aérea
    init();
	glutDisplayFunc(RenderScene);
	...
	Janela4 = glutCreateSubWindow(Janela1,511,399,512,369);   //visão da bola
	init();
	glutDisplayFunc(RenderScene);

...
GLfloat light_position2[] = { 0.0, 50.0, -150.0, 1.0 };
GLfloat light_position3[] = { 0.0, 50.0, -30.0, 1.0 };
...
int main(void)
{
	...
	Janela1 = glutCreateWindow("Visao Perspectiva");
	...
	Janela2 = glutCreateWindow("Visao Aérea");
